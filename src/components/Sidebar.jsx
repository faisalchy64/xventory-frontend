    ...
    <>
      ...
      <Offcanvas show={show} onHide={() => setShow(false)}>
        ...
        <Offcanvas.Body className="d-flex flex-column gap-3">
          {auth &&
            uris[auth.role].map((uri) => (
              <Link key={uri.id} to={uri.path}>
                <span
                  className={`d-flex align-items-center gap-2 px-3 py-2 my-0 rounded ${
                    pathname === uri.path
                      ? "bg-dark bg-gradient text-white"
                      : "text-dark border border-2 border-dark"
                  }`}
                >
                  {uri.icon} {uri.name}
                </span>
